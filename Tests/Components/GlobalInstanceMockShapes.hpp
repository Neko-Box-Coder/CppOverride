...
public:
    ...
    {
        CO_OVERRIDE_IMPL_INSTNACE(OverrideObj, float, (arg0));
        return float();
    }
...
public:
    ...
    {
        CO_OVERRIDE_IMPL_INSTNACE(OverrideObj, (std::tuple < float , T2 >), (arg0, arg1));
        return std::tuple < float , T2 >();
    }

    inline void TestComplexTypes(std::tuple < int , char > arg0, float arg1 = 1.f) 
    {
        CO_OVERRIDE_IMPL_INSTNACE(OverrideObj, void, (arg0, arg1));
        return void();
    }

    inline bool operator==(const Square < T > & arg0) const 
    {
        CO_OVERRIDE_IMPL_INSTNACE(OverrideObj, bool, (arg0));
        return bool();
    }
    ...
    {
        CO_OVERRIDE_IMPL_INSTNACE(OverrideObj, void, (arg0));
        return void();
    }
    ...
    {
        CO_OVERRIDE_IMPL_INSTNACE(OverrideObj, T, ());
        return T();
    }
